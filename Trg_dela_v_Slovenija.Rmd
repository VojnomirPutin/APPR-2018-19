...
source('analiza/analita_test.r', encoding='UTF-8')
```
...
```{r zemljevid_cluster, echo=FALSE, message=FALSE, error=FALSE, warning=FALSE, fig.align='center', fig.height=7, fig.width=10, fig.cap='Regije'}
